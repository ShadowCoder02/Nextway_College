 ...
 * pulls in the Supabase admin client and Node's crypto/path, neither safe
 * to bundle into a client component — so a future change to the limits
 * can't silently diverge between what the UI accepts and what the server
 * actually allows.
 */
